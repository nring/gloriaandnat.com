    ...
    return (
      <div>
        ...
        <ul className="list--faq">
          ...
          <li><strong>Will there be food?</strong><br/>Yes! We'll have passed hors d'oeuvres at cocktail hour, a plated dinner and lots of dessert. Still hungry after that? Go to 7-11.</li>
          ...
          <li><strong>Are children invited?</strong><br/> Please reach out to either of us if you want to bring your kids! Because Gloria is still recovering from the trauma, we should warn you that, as a child, she was kicked in the face at a wedding by a drunk attendee. </li>
